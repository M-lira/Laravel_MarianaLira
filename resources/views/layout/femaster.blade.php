...
<html lang="en">
<head>
    <link rel="icon" href="{{ asset('images/H.png') }}" type="image/x-icon">
  <meta charset="UTF-8">
...
<nav class="navbar navbar-expand-lg" style="background-color: transparent)">
  <div class="container-fluid">
    <a class="logo" href="{{route('home')}}"><img src="{{ asset('images/Harmoni.png') }}" width="30%" alt=""></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        @auth
        <li class="nav-item">
            <a class="nav-link" href="{{ route('dashboard.view') }}">Home</a>
        </li>
        @if (Auth::user()->userType == 1)
        <li class="nav-item">
            <a class="nav-link" href="{{ route('user.all') }}">Utilizadores</a>
        </li>
        @endif
        @endauth
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link" href="{{ route('album.all') }}">Álbuns</a>
        </li>
      </ul>
      <div>
        @if (Route::has('login'))
        <ul class="navbar-nav">
          @auth
          <div style="color: #2b2b2b; font-size: 18px; margin-right:25px"><i class="bi bi-music-note-list"></i> Olá, {{ Auth::user ()->name}}! </div>
          ...
          <li class="nav-item">
            ...
            <a class="btn-link"  href="{{ route('user.add') }}"><i class="bi bi-person-add"></i> Registo </a>
            {{-- @endif --}}
         </li>
         @endauth
        </ul>
