...
<div class="container">
  <div class="section_title">
    <h1 class="primary_title">Utilizadores</h1>
    <a class="btn btn-primary-blue" href="{{ route('user.add') }}">Adicionar utilizador</a>
  </div>
  ...
  <table class="table table-bordered border-dark tabela">
    <thead>
      <tr style="background-color: #2a2a2a">
        ...
        <th scope="col" class="col-1">Tipo de utilizador</th>
        @auth
